...
3. **Map**: ฝัง Google Maps (iframe แบบ lazy) ที่พิกัด 13.7299° N, 100.5333° E (Silom Edge Building) แสดง "COORD: 13.7299° N, 100.5333° E" และรูป `silom_Edge.jpg` จากเว็บเดิม
...
- SEO: `metadata` ต่อหน้า (title template "… | SHINASUB", description ไม่เกิน 160 ตัวอักษร เขียนจากเนื้อหาจริง), `opengraph-image.tsx` สร้าง OG image, `sitemap.ts`, `robots.ts`, JSON-LD `Organization` + `LocalBusiness` (ชื่อ, ที่อยู่, โทร, อีเมล, foundingDate 2013-12-06, geo 13.7299/100.5333), ลบค่า default "Generated by create next app"
...
- Bangkok Headquarters — COORD: 13.7299° N, 100.5333° E (Silom Edge Building)
